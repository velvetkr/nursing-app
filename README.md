...
| 身份 | 手机号 | 密码 | 说明 |
|---|---|---|---|
| 顾客 / 护理人员 | `13800138000` | `123456` | 多角色账号，可在登录页选择顾客或护理人员 |
| 护理人员 | `13800138001` | `123456` | 仅护理人员身份 |
| 商户 | `13800138002` | `123456` | 康宁护理中心商户成员 |
| 护理申请人 | `13800138003` | `123456` | 顾客身份，内置一份被驳回的护理人员申请 |
| 商户申请人 | `13800138004` | `123456` | 顾客身份，内置一份被驳回的商户入驻申请 |
...
Mock 管理员账号：`admin / 123456`。当前支持审核工作台，以及商户、护理人员和服务的列表、详情、通过、驳回与审核记录。
