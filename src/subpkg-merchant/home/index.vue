<template>
  <view class="page-shell">
    <view class="page-content">
      ...
      <view class="feature-grid"><view class="feature-card" @click="goOrders('dispatch')"><view class="feature-icon"><u-icon name="share" size="26" color="#3A7BF7" /></view><text class="feature-title">派单调度</text><text class="feature-desc">处理待派单和改派订单</text></view><view class="feature-card" @click="goServices"><view class="feature-icon"><u-icon name="grid" size="26" color="#3A7BF7" /></view><text class="feature-title">服务管理</text><text class="feature-desc">查看服务审核和上架状态</text></view><view class="feature-card" @click="goTeam"><view class="feature-icon"><u-icon name="account" size="26" color="#00A89D" /></view><text class="feature-title">团队管理</text><text class="feature-desc">护理团队、成员岗位与接单状态</text></view><view class="feature-card" @click="goComplaints"><view class="feature-icon orange-bg"><u-icon name="chat-fill" size="26" color="#E7833B" /></view><text class="feature-title">投诉协同</text><text class="feature-desc">响应顾客诉求并提交举证</text></view><view class="feature-card" @click="goSettlements"><view class="feature-icon green-bg"><u-icon name="rmb-circle" size="26" color="#00A89D" /></view><text class="feature-title">经营结算</text><text class="feature-desc">查看订单分账与可结算金额</text></view><view class="feature-card" @click="goReports"><view class="feature-icon purple-bg"><u-icon name="level" size="26" color="#7C68D6" /></view><text class="feature-title">经营数据</text><text class="feature-desc">订单趋势、质量指标与风险监控</text></view></view>
    </view>
...
.feature-icon.orange-bg { background:#fff2eb; }
.feature-icon.green-bg { background:#e9fbf7; }
.feature-icon.purple-bg { background:#f1edff; }
</style>
