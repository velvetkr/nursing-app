...
const menus = [{ label: '消息中心', desc: '订单、异常和投诉状态提醒', icon: 'bell', url: '/pages/notification/notification-list' }, { label: '经营结算', desc: '订单分账、可结算金额和记录', icon: 'rmb-circle', url: '/subpkg-merchant/settlements/index' }, { label: '经营数据', desc: '订单趋势、质量指标和风险监控', icon: 'level', url: '/subpkg-merchant/reports/index' }, { label: '切换身份', desc: '进入顾客或其他已开通工作台', icon: 'reload', url: '/pages/role-switch/role-switch' }, { label: '商户资料', desc: '主体资质与经营信息', icon: 'home', url: '/subpkg-merchant/apply/index' }, { label: '团队管理', desc: '护理人员合作与商户成员岗位', icon: 'account', url: '/subpkg-merchant/team/index' }, { label: '隐私与安全', desc: '账号与操作安全', icon: 'lock', url: '' }]
